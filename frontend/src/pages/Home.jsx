...
import card01 from "../assets/images/gallery-08.jpg";
    ...
    <>
          ...
          <div>
            <div className="my-8">
              ...
              <p className="text-lg leading-8 text-gray-800 hidden md:block">
                "Welcome to TripsFusion, your go-to destination for
      ...
      <section className="py-8 text-center px-6 md:px-12">
        ...
        <p className="text-lg leading-8 mb-8 text-gray-800">
          "Unveil travel wonders in our gallery, a snapshot of TripsFusion's
          adventures."
        </p>
        <ImagesGallery />
      </section>
